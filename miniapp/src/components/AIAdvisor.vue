  ...
  <div class="space-y-4">
    ...
    <div class="bg-dark-card border border-dark-border rounded-xl p-5">
      <div class="flex items-center gap-3 mb-4">
        <div class="w-10 h-10 rounded-lg bg-profit flex items-center justify-center">
          <svg class="w-5 h-5 text-dark" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
          </svg>
        </div>
        <div>
          <h3 class="font-semibold text-dark-text">AI Advisor</h3>
          <p class="text-xs text-dark-hint">3-way debate system</p>
        </div>
        <div class="ml-auto">
          <span class="px-2 py-1 rounded-full text-xs font-medium bg-profit/15 text-profit flex items-center gap-1">
            <span class="w-1.5 h-1.5 rounded-full bg-profit"></span>
            Active
          </span>
        </div>
      </div>
      ...
      <div class="relative mb-4">
        <input 
          ...
          class="w-full px-4 py-3 rounded-lg bg-dark-secondary border border-dark-border text-dark-text placeholder-dark-hint focus:outline-none focus:border-profit transition-colors"
        />
        <button 
          @click="analyzeQuery"
          class="absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-lg bg-profit text-dark"
        >
      ...
      <div class="flex flex-wrap gap-2">
        <button 
          ...
          class="px-3 py-1.5 rounded-lg text-xs font-medium bg-dark-secondary border border-dark-border text-dark-hint hover:border-dark-hint transition-colors"
        >
          {{ chip }}
        </button>
      </div>
    ...
    <div class="bg-dark-card border border-dark-border rounded-xl p-5">
      <h4 class="font-semibold text-dark-text mb-4 flex items-center gap-2">
        <svg class="w-5 h-5 text-profit" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
